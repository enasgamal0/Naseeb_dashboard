        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              <!-- Start:: Name Input -->
              <base-input col="3" type="text" :placeholder="$t('TABLES.Users.name')"
          ...
          <v-dialog v-model="user_wallet_modal">
            <v-card>
              ...
              <div class="w-100">
                <div class="mt-3">
                  <div>
                      <label class="font-weight-bold mx-1">{{ $t("SIDENAV.Clients.user_balance") }}: </label>
                      <input
                        type="number"
                      ...
                      <div class="mt-5">
                        <label class="font-weight-bold mx-1">{{ $t("SIDENAV.Clients.note2") }} ({{ $t("PLACEHOLDERS.optional") }}): </label>
                        <input
                          type="text"
                      ...
                      <div class="text-center mt-5">
                        <v-btn class="modal_confirm_btn mx-1 bg-success text-white" @click="changeBalance()" :disabled="button_waiting">{{$t("BUTTONS.save")}}</v-btn>
                        <v-btn class="modal_confirm_btn mx-1 bg-danger text-white" @click="closeWalletModal()">{{$t("BUTTONS.cancel")}}</v-btn>
                      </div>
                    </div>
                </div>
              </div>
