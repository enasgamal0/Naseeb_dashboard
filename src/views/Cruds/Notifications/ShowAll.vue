...
export default {
  ...
  data() {
    return {
      ...
      recerveTypes: [
        {
          id: 0,
          name: this.$t("PLACEHOLDERS.clientorder"),
          value: "client",
        },
        {
          id: 2,
          name: this.$t("PLACEHOLDERS.providerorder"),
          value: "provider",
        },
      ],
    };
  ...
  methods: {
    ...
    async resetFilter() {
      ...
      this.filterOptions.recerveType = null;
      if (this.$route.query.page !== "1") {
        await this.$router.push({
          path: "/all-notifications/all",
          query: { page: 1 },
      ...
      try {
        let res = await this.$axios({
          ...
          params: {
            ...
            type: this.filterOptions.recerveType?.value,
          },
        });
        this.loading = false;
