      ...
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('SIDENAV.banks.count_use')"
  ...
  methods: {
    ...
    async showBank() {
      try {
        ...
        this.data.name_ar = res.data.data.Bank.name_ar;
        this.data.name_en = res.data.data.Bank.name_en;
        this.data.count_use = res.data.data.Bank.count_use;
