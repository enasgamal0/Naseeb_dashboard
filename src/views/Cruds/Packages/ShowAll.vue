          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-select-input
                ...
                v-model="filterOptions.capacity"
              />
              <!-- End:: Status Input -->
...
export default {
  ...
  data() {
    return {
      ...
      tableHeaders: [
        ...
        {
          text: this.$t("PLACEHOLDERS.capacity"),
          value: "formattedCapacities",
          sortable: false,
          align: "center",
        },
        {
  ...
  methods: {
    ...
    async resetFilter() {
      ...
      this.filterOptions.capacity = null;
    ...
    async setTableRows() {
      ...
      try {
        const params = {
          ...
          capacity: this.filterOptions.capacity?.id,
        ...
        this.loading = false;
        this.tableRows = res.data.data.map(item => ({
          ...item,
          formattedCapacities: item.capacities.map(capacity => 
            capacity.name
          ).join(' & '),
        }));
